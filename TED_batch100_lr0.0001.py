...
n_steps =10000000 #make this number smaller to test if this code works, ideally should have 2000
print_every = 10
validate_every = 10
z_dim = 100
input_dim = 768 #dim of embeddings
batch_size =100 #number of sentence to choose each time {32, 16, 8}
...
optimizer = optim.Adam(net.parameters(),lr=0.0001,betas=(0.9,0.99),weight_decay=0.00001)
