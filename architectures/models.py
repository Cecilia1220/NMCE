...
class SubspaceClusterNetwork(nn.Module):
    def __init__(self,input_dim,z_dim,n_clusters,norm_p=2,normalize=False):
        super().__init__()
        self.norm_p = norm_p
        self.normalize = normalize
        
        self.cluster = nn.Linear(input_dim,n_clusters)
        self.subspace = nn.Linear(input_dim,z_dim)
